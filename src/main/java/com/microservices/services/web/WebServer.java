...
public class WebServer {
	 ...
	 * doesn't matter.
	 */
	public static final String PHONE_SERVICE_URL = "http://PHONES-SERVICE";
	 ...
	 */
	@Bean
	public WebAccountsService phoneService() {
		return new WebAccountsService(PHONE_SERVICE_URL);
	}
	...
	public WebAccountsController accountsController() {
		return new WebAccountsController(phoneService());
	}
